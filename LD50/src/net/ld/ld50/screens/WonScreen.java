...
public class WonScreen extends MenuScreen {
	...
	public WonScreen(ScreenManager pScreenManager, GameState pGameState) {
		super(pScreenManager, "WELL DONE");
		...
		final var lExitToMenuEntry = new MenuEntry(pScreenManager, lListLayout, "Quit");
